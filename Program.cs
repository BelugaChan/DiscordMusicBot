    ...
    public class Program
    {
        ...
        public class MusicSL : ApplicationCommandModule
        {
            ...
            public static async Task ControlCommand(InteractionContext ctx)
            {
                ...
                Button stop = new(ButtonStyle.Primary, "stop_button", "stop");
                var buttonCompStop = new DiscordButtonComponent(stop.Style, stop.CustomId, stop.Label, false, stop.Emoji);
            ...
            //    [Option("url", "write youtube url")] string url = null,
